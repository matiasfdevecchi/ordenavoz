...
import { Order, OrderId, OrderStatus, PaymentByMercadoPago, PaymentMethod } from "../domain/Order";
...
class PayOrderByMercadoPago {
    ...
    async invoke(id: OrderId, amount: number, operationId: string | undefined): Promise<Order> {
        ...
        const payment: PaymentByMercadoPago = {
...
export const payOrderByMercadoPago = new PayOrderByMercadoPago(orderService, orderRepository, orderNotifier, printerService);